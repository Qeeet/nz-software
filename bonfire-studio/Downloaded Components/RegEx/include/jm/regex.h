...
public:
   ...
   {
      #ifdef JM_MSC_VER
      static_cast<JM_STD::exception*>(this)->operator=(e);
      #else
...
public:
   ...
   bool RE_CALL operator==(const reg_expression&)const;
   bool RE_CALL operator<(const reg_expression&)const;
...
struct sub_match
{
   ...
   bool RE_CALL operator !=(const sub_match& that)const
   { return !(*this == that); }
...
public:
   ...
   bool operator==(const reg_match_base& that)const;
   bool operator<(const reg_match_base& that)const
