...
CNZDockContext::CNZDockContext(CControlBar* pBar) : CDockContext(pBar)
{
	ASSERT(pBar != NULL);
...
/////////////////////////////////////////////////////////////////////////////
// CNZDockContext Drag Operations

void CNZDockContext::StartDrag(CPoint pt)
{
	ASSERT_VALID(m_pBar);
	m_bDragging = TRUE;
...
void CNZDockContext::Move(CPoint pt)
{
...
void CNZDockContext::OnKey(int nChar, BOOL bDown)
{
	if (nChar == VK_CONTROL)
...
/////////////////////////////////////////////////////////////////////////////
// CNZDockContext Resize Operations
...
void CNZDockContext::StartResize(int nHitTest, CPoint pt)
{
	ASSERT_VALID(m_pBar);
...
void CNZDockContext::Stretch(CPoint pt)
{
	CPoint ptOffset = pt - m_ptLast;
...
/////////////////////////////////////////////////////////////////////////////
// CNZDockContext Double Click Operations

void CNZDockContext::ToggleDocking()
{
...
/////////////////////////////////////////////////////////////////////////////
// CNZDockContext Operations

void CNZDockContext::InitLoop()
{
...
void CNZDockContext::CancelLoop()
{
...
void CNZDockContext::DrawFocusRect(BOOL bRemoveRect)
{
	ASSERT(m_pDC != NULL);
...
void CNZDockContext::UpdateState(BOOL* pFlag, BOOL bNewValue)
{
	if (*pFlag != bNewValue)
	{
		*pFlag = bNewValue;
...
CDockBar* CNZDockContext::GetDockBar(DWORD dwOverDockStyle)
{
	DWORD dw = 0;
	CDockBar* pBar;
