...
void CCrystalEditView::OnEditReplace() 
{
	...
	dlg.m_sReplaceText = pApp->GetProfileString(REG_REPLACE_SUBKEY, REG_REPLACE_WITH, _T(""));
	...
	pApp->WriteProfileString(REG_REPLACE_SUBKEY, REG_REPLACE_WITH, dlg.m_sReplaceText);
}
