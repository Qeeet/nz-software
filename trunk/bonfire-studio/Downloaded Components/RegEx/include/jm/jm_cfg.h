...
/* STL configuration goes here: */
   ...
   #include <iterator>
      ...
      #define JM_RA_ITERATOR(T, D) JM_STD::random_access_iterator<T, D>
      ...
      #if defined(__STL_USE_STD_ALLOCATORS) && !defined(__GNUC__)
         ...
         #define JM_DEF_ALLOC_PARAM(x) JM_DEFAULT_PARAM( JM_STD::alloc )
         #define JM_DEF_ALLOC(x) JM_STD::alloc 
