...
public:
	...
	static DWORD AddFileFolder(LPCTSTR lpszFileName, HWND hWnd, CDocument* pDocument=NULL);
	static void SetData(DWORD dwHandle, DWORD dwData);
	static void SetAutoReload(DWORD dwHandle, BOOL* pbAutoReload);
	static bool Dialog(LPCTSTR lpszPathFile, CWnd* pParent);
